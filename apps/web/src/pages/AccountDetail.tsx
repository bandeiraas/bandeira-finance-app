...
export default function AccountDetail() {
  ...
  // ⚡ Bolt: Consolidated multiple array passes into a single O(N) loop to reduce CPU cycles during component render.
  let monthIncome = 0;
  let monthExpense = 0;
  const categoryTotals: Record<string, number> = {};

  for (const t of monthTransactions) {
    const amount = Number(t.amount); // amount string parsed from JSON
    if (t.type === "income") {
      monthIncome += amount;
  ...
  const totalChartPercent =
    categoriesWithPercent.reduce((s, c) => s + c.percentage, 0) || 75;
  ...
  return (
    <div
      ...
      style={{ ["--bank-accent"]: bankHex } as React.CSSProperties}
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            style={{
              ...
              boxShadow: `0 10px 40px ${bankHex}40`,
            }}
          >
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        <div className="w-full xl:w-1/3 space-y-6">
          ...
          <div className="glass-card p-6 rounded-3xl">
            <h3 className="font-display font-semibold text-slate-800 dark:text-white mb-5">
              Categorias de Gastos
            </h3>
                ...
                >
                  ...
                  {categoriesWithPercent.length > 0 ? (
                        ...
                        <circle
                          ...
                          className={
                            isFirst
                              ? ""
                              : CHART_COLOR_CLASSES[
                                  (i - 1) % CHART_COLOR_CLASSES.length
                                ]
                          }
                          cx="18"
                          cy="18"
                    ...
                    <circle
                      ...
                      strokeWidth={4}
                      style={{ stroke: bankHex }}
                    />
                  )}
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-[10px] font-bold text-slate-500">
                    {Math.round(totalChartPercent)}%
                  </span>
                </div>
              </div>
          ...
          <div className="glass-card p-6 rounded-3xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <span
                ...
                style={{
                  backgroundColor: `${bankHex}30`,
                  color: bankHex,
                  borderColor: `${bankHex}50`,
                }}
              >
                4 PENDENTES
              </span>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex justify-between items-end">
                      <span className="text-2xl font-bold tracking-tight">
                        {formatCurrency(Number(primaryCard.credit_limit))}
                      </span>
