...
export default function Register() {
    ...
    const handleGoogleRegister = async () => {
        ...
        try {
            ...
            // Redirecionamento via fluxo OAuth; usuário retorna com sessão
        } catch (err) {
    ...
    return (
        <div className="font-body text-slate-700 dark:text-slate-300 bg-[linear-gradient(135deg,#f8fafc_0%,#e2e8f0_100%)] dark:bg-[linear-gradient(135deg,#0f172a_0%,#1e293b_100%)] min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            {/* Background Blobs */}
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-[20px] border border-white dark:border-slate-700 shadow-[0_20px_40px_-10px_rgba(15,23,42,0.1),0_0_15px_rgba(0,0,0,0.05)] dark:shadow-xl rounded-3xl p-8 sm:p-10 w-full">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 ml-1" htmlFor="name">Nome completo</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                    <User className="text-slate-400 dark:text-slate-500 group-focus-within:text-slate-600 dark:group-focus-within:text-slate-300 transition-colors" size={20} />
                                </div>
                                <input
                                    type="text"
                                    id="name"
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 ml-1" htmlFor="email">E-mail</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 ml-1" htmlFor="password">Senha</label>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        ...
                        <div className="flex items-start">
                            <div className="flex items-center h-5">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-4 h-4 border-slate-300 dark:border-slate-600 rounded text-slate-900 dark:text-white focus:ring-slate-900 dark:focus:ring-white"
                                    required
                                    disabled={isLoading}
                                />
                            </div>
                            <div className="ml-3 text-sm">
                                <label htmlFor="terms" className="text-slate-500 dark:text-slate-400">
                                    Aceito os <a href="#" className="font-medium text-slate-900 dark:text-white hover:text-sky-500 transition-colors">Termos e Condições</a> e a <a href="#" className="font-medium text-slate-900 dark:text-white hover:text-sky-500 transition-colors">Política de Privacidade</a>.
                                </label>
                            </div>
                        </div>
                    ...
                    <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center text-xs uppercase tracking-wide">
                            <span className="px-3 bg-white dark:bg-slate-900/95 text-slate-400 dark:text-slate-500 font-medium">ou registre-se com</span>
                        </div>
                    </div>
                    ...
                    <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-8">
                        Já tem uma conta?{" "}
                        <Link to="/login" className="font-bold text-slate-900 dark:text-white hover:text-sky-500 transition-colors">
                            Fazer Login
                        </Link>
                    </p>
                </div>
