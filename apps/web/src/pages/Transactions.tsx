    ...
    <div className="space-y-6 animate-fade-in">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/new-income"
            className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold transition-colors flex items-center gap-2 text-sm shadow-lg shadow-emerald-500/20"
          >
            <Plus size={18} />
            Receita
          </Link>
          <Link
            to="/new-expense"
            className="px-4 py-2 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-bold transition-colors flex items-center gap-2 text-sm shadow-lg shadow-rose-500/20"
          >
            <Minus size={18} />
            Despesa
          </Link>
        ...
        {isLoading ? (
            ...
            {filteredTransactions.map((t) => (
              ...
              >
                ...
                <div className="flex items-center gap-6">
                  <span
                    className={cn(
                      "font-bold font-display whitespace-nowrap",
                      t.type === "income"
                        ? "text-emerald-500"
                        : "text-rose-500",
                    )}
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-slate-500 max-w-xs mx-auto mb-6">
              Não encontramos nenhuma transação com os filtros selecionados.
            </p>
            <div className="flex justify-center gap-3">
              <Link
                to="/new-income"
                className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold transition-colors text-sm"
              >
                Adicionar Receita
              </Link>
              <Link
                to="/new-expense"
                className="px-5 py-2.5 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-bold transition-colors text-sm"
              >
                Adicionar Despesa
              </Link>
            </div>
