...
export default function AccountDetail() {
    ...
    // ⚡ Bolt: Consolidate multiple sequential .filter().reduce() array iterations
    // into a single O(N) pass to calculate income, expenses, and category totals simultaneously.
