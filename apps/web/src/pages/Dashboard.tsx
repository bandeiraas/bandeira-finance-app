...
export default function Dashboard() {
    ...
    // Safely update selected card index during render to avoid cascading updates
    const previousCardsLength = useState(displayCards.length)[0];
    const maxIndex = Math.max(0, displayCards.length - 1);
    if (displayCards.length !== previousCardsLength && selectedCardIndex > maxIndex) {
