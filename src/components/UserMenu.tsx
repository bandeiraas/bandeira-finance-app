    ...
    return (
        <div className="relative group" ref={menuRef}>
            <button
                ...
                className="flex items-center gap-3 glass-card py-1 px-1 pr-4 rounded-full cursor-pointer transition-all hover:bg-white/10"
            >
                <img
                    alt="Profile avatar"
                ...
                />
                <span className="text-sm font-medium hidden md:block text-white">Alex Silva</span>
