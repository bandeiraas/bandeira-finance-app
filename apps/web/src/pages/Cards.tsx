                        ...
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="glass-card flex items-center justify-between px-4 py-2 rounded-xl w-full md:w-64 border border-white/10 bg-slate-800/50">
                                    ...
                                    <button aria-label="Copiar final do cartão" onClick={() => copyToClipboard(selectedCard.last_four)} className="p-2 text-primary hover:bg-primary/20 rounded-lg transition-colors">
                                        <Copy size={16} />
                                    </button>
                                </div>
                            </div>
