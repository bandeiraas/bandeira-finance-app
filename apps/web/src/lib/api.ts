...
export const api = {
    ...
    cards: {
        ...
        create: (token: string, data: { brand: string; last_four: string; expiry: string; card_name: string; credit_limit: number; card_color?: string; account_id: string; due_day?: number; closing_day?: number }) =>
