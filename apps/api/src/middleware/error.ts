...
export function errorHandler(err: Error, c: Context) {
    ...
    const sanitizedError = err && typeof err === 'object' ? {
        name: 'name' in err ? (err as unknown as Record<string, unknown>).name : undefined,
        message: 'message' in err ? (err as unknown as Record<string, unknown>).message : undefined,
